/**
 * Shared workspace Account panel — identical controls to Chuck v2:
 * Paddle/PayPal upgrade, billing portal, password, 2FA, close account.
 */
...
const EMPTY_PADDLE_CONFIG: PaddlePublicConfig = {
  enabled: false,
  environment: "sandbox",
  clientToken: "",
  customerId: null,
...
export function useWorkspaceAccount(user: WorkspaceAccountUser | null | undefined) {
  ...
  const accountOverlays: ReactNode = !user ? null : (
    <>
