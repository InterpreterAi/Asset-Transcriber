...
import { useTranscriptionMorsyBaseline } from "@/hooks/use-transcription-morsy-baseline";
...
// ── Main workspace ─────────────────────────────────────────────────────────────
export default function WorkspaceMorsy() {
  ...
  const snapshotCtxRef = useRef<{
    transcription: ReturnType<typeof useTranscriptionMorsyBaseline> | null;
    debounce: ReturnType<typeof setTimeout> | null;
  }>({ transcription: null, debounce: null });

  const transcription = useTranscriptionMorsyBaseline(user?.isAdmin ?? false, {
