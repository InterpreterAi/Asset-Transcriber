...
const ARABIC_DIALECT_TO_MSA: readonly [string, string][] = [
  ...
  ["دي", "هذه"],
  ["أهو", "ها هو"],
  // Egyptian / colloquial leaks from bilingual beauty & medical sessions
  ["أنا ليس زي", "لست مثل"],
  ["ليس زي", "ليس مثل"],
  ["أبين زي", "أبدو مثل"],
  ["ابين زي", "أبدو مثل"],
...
/**
 * Arabic word replace that still matches after coordinating clitics و/ف/ب/ك/ل
 * so "وهنجيب" / "بزي" rewrite (plain lookbehind treated those as mid-word).
 */
