...
export function LiveAudioMeter({ stream }: { stream: MediaStream | null }) {
  ...
  return (
    <div className="flex flex-col gap-1 w-full min-w-[4.5rem]">
      <div className="flex items-center justify-between gap-1 text-[10px] font-semibold tabular-nums text-muted-foreground leading-none">
        <span className="sr-only">Input level</span>
